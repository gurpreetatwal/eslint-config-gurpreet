# Gurpreet's ESLint Config [![Build Status](https://travis-ci.org/gurpreetatwal/eslint-config-gurpreet.svg?branch=master)](https://travis-ci.org/gurpreetatwal/eslint-config-gurpreet)
